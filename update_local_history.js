...
class CoinbaseGlobalHistory {
    constructor() {
        this.accounts = {} // All accounts, identified by their coinbase ID
        this.orders = {} // All orders referenced by account history, identified by their coinbase ID
    }
}
